                    ...
                    <div class="card">
                        <div class="card-header border-bottom">
                            <div class="row g-2">
                                ...
                                <form class="form-horizontal" method="post" action="{{route('user.filtros')}}"
                                    novalidate>
                                    @csrf
                                    <div class="row mb-2">
                                        <div class="col-md">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @if ($usuario->estado == 'NUEVO')
                                                                        ...
                                                                        <a href="{{ route('usuario.estado', ['usuario' => $usuario, 'estado' => 'rechazado']) }}" class="btn btn-danger">
...
>>>>>>> fa03f80216a75b0280a23ed3bab9c1a337a5908b
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-primary" id="btnPrEditSave">Filtrar</button>
                                    ...
                                    <div class="table-responsive export-table">
                                        <table id="file-datatable"
                                            ...
                                            <tbody>
                                                @foreach ($usuarios as $usuario)
                                                <tr>
                                                    {{-- <img src="{{Storage::get(" $usuario->photo")}}" class="avatar
                                                    ...
                                                    <td>
                                                        ...
                                                        <span>
                                                            ...
                                                            <a href="" data-bs-toggle="modal"
                                                                data-bs-target="#exampleModal" class="aImg">
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($usuario->estado == 'Asociado')
                                                        <a href="" data-bs-toggle="modal"
                                                            data-bs-target="#exampleModalProveedor"
