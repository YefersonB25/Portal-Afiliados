            ...
            <table class="table table-striped mt-2">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if ($usuario->estado != 2)
                    <a onclick="delecteItem(event)"
                      href="{{ route('usuario.confirmar', ['idUsuario' => $usuario->id]) }}"
                      class="btn btn-danger">Confirmar</a>
                    @endif
                    <a class="nav-link" href="{{ url('usuarios/config/'.$usuario->identification) }}">
                      envio cc
                    </a>
...
>>>>>>> 50601c7530a04831831ad8626707a55ac76e0d44
