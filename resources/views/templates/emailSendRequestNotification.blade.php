...
<head>
    ...
    <title>Get to know our product</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                                                ...
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        ...
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:14px"><img
                                                                            src="images/vector.png" alt="Logo"
                                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            height="60" title="Logo" width="38"></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-txt-c"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        target="_blank" href="{{ route('auth.login') }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:18px">
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <br>Me dirijo a ustedes con el fin de solicitar
                                                                        el acceso en su plataforma/sistema. Mi nombre es
                                                                        {{$nameUserRegistre }}.
                                                                        <br><br>Agradezco de antemano su atención a mi
                                                                        solicitud y espero poder comenzar a utilizar la
                                                                        plataforma/sistema lo antes
                                                                        posible. Por favor, háganme saber si necesitan
                                                                        alguna información adicional o si hay algún
                                                                        requisito adicional que deba
                                                                        cumplir.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                                                        Gracias,<br><br>Portal Afiliados TC<br>Copyright
                                                                        ©
                                                                        {{date('Y')}}. Tractocar, Departamento de
                                                                        Informatica.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <td align="center" class="es-m-txt-l"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        ...
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:18px"><img
                                                                            src="images/group.png" alt="Demo"
                                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            width="70" title="Demo" height="70"></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        Get to know our product during a one-on-one
                                                                        video call with our experts. We will be happy to
                                                                        introduce you to all the interesting features.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    ...
                                                                    <!--[if !mso]>--><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#2CB543;background:#7630f3;border-width:0px;display:block;border-radius:30px;width:auto;mso-hide:all"><a
                                                                            ...
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:22px;display:block;background:#7630f3;border-radius:30px;font-family:Imprima, Arial, sans-serif;font-weight:bold;font-style:normal;line-height:26px;width:auto;text-align:center;padding:15px 20px 15px 20px;mso-hide:all;border-left-width:5px;border-right-width:5px;border-color:#7630f3">Ingresar</a></span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <img src="images/twitter-logo-black.png"
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                style="padding:0;Margin:0;padding-right:5px">
                                                                                <img src="images/facebook-logo-black.png"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        © 2022 Company<a target="_blank" href=""
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-infoblock made_with"
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="https://viewstripo.email/?utm_source=templates&utm_medium=email&utm_campaign=cold_emails_2&utm_content=get_to_know_our_product"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px"><img
                                                                            src="images/7911561025989373.png" alt
                                                                            width="125"
                                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            height="56"></a>
                                                                </td>
