...
<body>
    <h1>Tu nueva contraseña es: {{ $request }}</h1>
    <p>Por favor, cámbiala después de iniciar sesión por razones de seguridad.</p>
</body>
...
<body
    ...
    <div class="es-wrapper-color" style="background-color:#07023C"><!--[if gte mso 9]>
        ...
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#07023C">
            <tr>
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#ffffff;background-repeat:no-repeat;width:600px;background-image:url(https://zgekuy.stripocdn.email/content/guids/CABINET_0e8fbb6adcc56c06fbd3358455fdeb41/images/vector_0Ia.png);background-position:center center"
                                    cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"
                                    background="https://zgekuy.stripocdn.email/content/guids/CABINET_0e8fbb6adcc56c06fbd3358455fdeb41/images/vector_0Ia.png">
                                    <tr>
                                        <td align="left"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        ...
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#26C6DA;font-size:14px"><img
                                                                            src="https://zgekuy.stripocdn.email/content/guids/CABINET_c67369b1c7e6c5022f89a2d5c95beeaf03377713bedecca21402e62dfd866718/images/tcl_pos_cmyk01_MFW.png"
                                                                            alt="Logo"
                                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            title="Logo" height="55"
                                                                            width="74"></a></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="es-m-p0r es-m-p20b" valign="top" align="center"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px;font-size:0px">
