                                    ...
                                    <div class="card overflow-hidden">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <h3 class="mb-2 fw-semibold">{{$nuevas_solicitudes}}</h3>
                                                    <p class="text-muted fs-13 mb-0">Nuevas Solicitudes</p>
                                ...
                                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                                    <div class="card overflow-hidden">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h3 class="mb-2 fw-semibold">{{$solicitudes_confirmadas}}</h3>
                                                    <p class="text-muted fs-13 mb-0">solicitudes Confirmados</p>
                                                    {{-- <p class="text-muted mb-0 mt-2 fs-12">
                                ...
                                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                                    <div class="card overflow-hidden">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h3 class="mb-2 fw-semibold">{{$solicitudes_rechazadas}}</h3>
                                                    <p class="text-muted fs-13 mb-0">solicitudes Rechazadas</p>
                                                    {{-- <p class="text-muted mb-0 mt-2 fs-12">
                                                        <span class="icn-box text-success fw-semibold fs-13 me-1">
                                                            <i class='fa fa-long-arrow-up'></i>
                                                            27%</span>
                                ...
                                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                                    <div class="card overflow-hidden">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h3 class="mb-2 fw-semibold">{{$total_usuarios}}</h3>
