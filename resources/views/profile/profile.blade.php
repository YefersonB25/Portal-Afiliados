                                    ...
                                    <div class="col-lg-12 col-md-12 col-xl-6">
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="ms-4">
                                                ...
                                                <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-rss"></i>
                                                    Follow</a>
                                                <a href="mail-inbox.html" class="btn btn-secondary btn-sm"><i
                                ...
                                <div class="card">
                                    <div class="card-body p-0">
                                        {{-- <div class="p-5">
                                            ...
                                            <p class="text-dark-light">Hi I'm Teri Dactyl,has been the industry's
                                                standard dummy text ever since the 1500s, when an unknown printer took a
                                                galley of type. Donec pede justo, fringilla vel, aliquet nec, vulputate
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="text-primary">websitenamename.com</a>
                                                    <p class="mb-2 mt-3"><b>2010-2015</b></p>
                                                    <p class="text-muted text-14">Lorem Ipsum is simply dummy text of
                                                ...
                                                <div>
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="text-primary">samplewebsite.com</a>
                                                    <p class="mb-2 mt-3"><b>2007-2009</b></p>
                                                    <p class="text-muted text-14 mb-0">Lorem Ipsum is simply dummy text
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="profile-cover__info ms-4 ms-auto p-0">
                                                <ul class="nav p-0 border-bottom-0 mb-0">
                                                    <li
                                                        class="border p-2 br-5 bg-light-lightest wpx-100 hpx-70 text-center my-1">
                                                        <span class="border-0 mb-0 pb-0 fs-21">113</span>
                                                        Projects
                                                    </li>
                                                    <li
                                                        class="border p-2 br-5 bg-light-lightest wpx-100 hpx-70 text-center mx-2 my-1">
                                                    ...
                                                    <div class="main-profile-contact-list">
                                                        <div class="media mx-2">
                                                            <div class="media-icon bg-info-transparent text-info"> <i
                                                                    class="fe fe-map-pin fs-21"></i> </div>
                                                            <div class="media-body ms-2">
                                            ...
                                            <div class="d-md-flex">
                                                ...
                                                <div>
                                                    <div class="main-profile-contact-list">
                                                        <div class="media mx-2">
                                                            <div class="media-icon bg-success-transparent text-success">
                                                                <i class="fe fe-twitter fs-21"></i>
                                                            </div>
                                                            <div class="media-body ms-2">
                                                                <span class="text-muted">Twitter</span>
                                                                <p class="mb-0"> <a href="javascript:void(0)"
                                                                        class="text-default">twitter.com/spruko.me</a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="main-profile-contact-list">
                                                        <div class="media mx-2">
                                                            <div class="media-icon bg-info-transparent text-info"> <i
                                                                    class="fe fe-linkedin fs-21"></i> </div>
                                                            <div class="media-body ms-2">
                                                                <span class="text-muted">Linkedin</span>
                                                                <p class="mb-0"> <a href="javascript:void(0)"
                                                                        class="text-default">linkedin.com/in/spruko</a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card border">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="media mt-4 profile-footer align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-0 text-bold text-dark-light">28 people like your
                                                            photo</h6>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                        <div class="card custom-card border">
                                            <div class="card-body user-lock text-center">
                                                ...
                                                <a href="#">
                                                    <img alt="avatar" class="avatar avatar-xl rounded" src="{{asset("
                                                        $asociado->photo")}}">
                                                            ...
                                                            <ul class="text-center">
                                                                ...
                                                                <li>
                                                                    <a class="social-icon" href="javascript:void(0)"
                                                                        ...
                                                                        title="Facebook"><i class="fa fa-refresh"></i>
                                                                    </a>
                                                                </li>
                                                                @endif
                                                                {{-- <li>
                                            ...
                                            <div class="form-group " data-select2-id="108">
                                                <div class="row" data-select2-id="107">
                                                    ...
                                                    <div class="col-md-9" data-select2-id="106">
                                                        <select class="form-control select2" id="language" tabindex="-1"
                                                            aria-hidden="true">
                                                ...
                                                <div class="row" data-select2-id="9">
                                                    ...
                                                    <div class="col-md-9" data-select2-id="8">
                                                        <select class="form-control select2" id="timeZone"
                                                            ...
                                                            <option value="Etc/GMT+10" data-select2-id="17">(GMT-10:00)
                                                                Hawaii</option>
                                                            ...
                                                            <option value="Etc/GMT+8" data-select2-id="22">(GMT-08:00)
                                                                Pitcairn Islands</option>
                                                            <option value="America/Los_Angeles" data-select2-id="23">
                                                            ...
                                                            <option value="America/Dawson_Creek" data-select2-id="26">
                                                            ...
                                                            <option value="America/Campo_Grande" data-select2-id="38">
                                                            ...
                                                            <option value="America/Argentina/Buenos_Aires"
                                                                data-select2-id="46">(GMT-03:00) Buenos Aires</option>
                                                            ...
                                                            <option value="Atlantic/Cape_Verde" data-select2-id="49">
                                                                (GMT-01:00) Cape Verde Is.</option>
                                                            <option value="Atlantic/Azores" data-select2-id="50">
                                                                (GMT-01:00) Azores</option>
                                                            <option value="Europe/Belfast" data-select2-id="51">(GMT)
                                                                Greenwich Mean Time : Belfast</option>
                                                            ...
                                                            <option value="Africa/Abidjan" data-select2-id="55">(GMT)
                                                            ...
                                                            <option value="Asia/Beirut" data-select2-id="61">(GMT+02:00)
                                                                Beirut</option>
                                                            <option value="Africa/Cairo" data-select2-id="62">
                                                                (GMT+02:00) Cairo</option>
                                                            <option value="Asia/Gaza" data-select2-id="63">(GMT+02:00)
                                                                Gaza</option>
                                                            ...
                                                            <option value="Asia/Tehran" data-select2-id="70">(GMT+03:30)
                                                                Tehran</option>
                                                            <option value="Asia/Dubai" data-select2-id="71">(GMT+04:00)
                                                                Abu Dhabi, Muscat</option>
                                                            <option value="Asia/Yerevan" data-select2-id="72">
                                                                (GMT+04:00) Yerevan</option>
                                                            <option value="Asia/Kabul" data-select2-id="73">(GMT+04:30)
                                                                Kabul</option>
                                                            ...
                                                            <option value="Asia/Dhaka" data-select2-id="78">(GMT+06:00)
                                                                Astana, Dhaka</option>
                                                            ...
                                                            <option value="Asia/Tokyo" data-select2-id="87">(GMT+09:00)
                                                                Osaka, Sapporo, Tokyo</option>
                                                            <option value="Asia/Seoul" data-select2-id="88">(GMT+09:00)
                                                                Seoul</option>
                                                            ...
                                                            <option value="Australia/Lord_Howe" data-select2-id="95">
                                                                (GMT+10:30) Lord Howe Island</option>
                                                            <option value="Etc/GMT-11" data-select2-id="96">(GMT+11:00)
                                                            ...
                                                            <option value="Asia/Anadyr" data-select2-id="99">(GMT+12:00)
                                                                Anadyr, Kamchatka</option>
                                                            <option value="Pacific/Auckland" data-select2-id="100">
                                                                (GMT+12:00) Auckland, Wellington</option>
                                                            <option value="Etc/GMT-12" data-select2-id="101">(GMT+12:00)
                                                            ...
                                                            <option value="Pacific/Kiritimati" data-select2-id="104">
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="custom-checkbox custom-control mx-2">
                                                            ...
                                                            <label for="personal" class="custom-control-label">Required
