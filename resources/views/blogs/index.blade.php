                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="main-container container-fluid">
                                            ...
                                            {{-- <a href="{{ route('admin.log') }}" class="btn btn-info mb-3"><i
                                                    class="fas fa-file-alt"></i> Log</a> --}}
                                                ...
                                                <div class="card-body">
                                                    {{-- <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link active" id="home-tab" data-toggle="tab"
                                                                ...
                                                                aria-selected="true">Profesores colegio</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link" id="profile-tab" data-toggle="tab"
                                                                href="#profile" role="tab" aria-controls="profile"
                                                                aria-selected="false">Profesores universidades</a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="tab-content mt-3" id="myTabContent">
                                                        <div class="tab-pane fade show active" id="home" role="tabpanel"
                                                            ...
                                                            <form method="post" action="{{ route('import.profesorC') }}"
                                                        ...
                                                        <div class="tab-pane fade" id="profile" role="tabpanel"
                                                            ...
                                                            <form method="post" action="{{ route('import.profesorU') }}"
                                                                class="needs-validation" novalidate
                                                                enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="mb-3 col-md-3">
                                                                ...
                                                                {{-- <form method="post"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <input type="text" placeholder="0000000000"
                                                                            name="numdoc" class="form-control"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <select name="empresa"
                                                                            class="form-control tipo_destinon"
                                                                            id="validationCustom01" value="" required>
                                                                    ...
                                                                    <div class="col-md-6" style="margin-top:20px">
                                                                        <label for="validationCustom01"
                                                                            class="form-label nn">Establecimiento</label>
                                                                        <select name="" class="form-control n0"
                                                                            id="validationCustom01" value="" required>
                                                                            <option value=""
                                                                                placeholder="seleccione..."></option>
                                                                        </select>

                                                                        <select name="dane_empresa"
                                                                            style="display: none"
                                                                            class="form-control n1"
                                                                            id="validationCustom04" value="" required>
                                                                            <option value="">Seleccione...</option>
                                                                            @foreach ($colegios as $col)
                                                                            <option value="{{$col->col_dane_colegio}}">
                                                                                {{$col->col_nombre}}</option>
                                                                            @endforeach
                                                                        </select>

                                                                        <select name="dane_empresa"
                                                                            style="display: none"
                                                                            class="form-control n2"
                                                                            id="validationCustom05" value="" required>
                                                                            <option value="">Seleccione...</option>
                                                                            @foreach ($universidades as $uni)
                                                                            <option value="{{$uni->uni_codigo}}">
                                                                                {{$uni->uni_nombre}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <table id="file-datatable"
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="border-bottom-0">Identificacion
                                                                            </th>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>{{$arrayResult['firstName'] .'
                                                                                '.$arrayResult['firstName']}}
                                                                            </td>
    ...
    $('#pagadas').on('click', function(e){
            ...
            $.ajax({
                ...
                success: (response) => {
                    ...
                    //     console.log(`For index ${key}, data value is ${value.AmountPaid}`);
