    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                <img src={{asset('assets/images/brand/logo.pngassets/css/icons.css')}} class="header-brand-img desktop-logo" alt="logo">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <a class="dropdown-item" href="{{route('profile')}}" data-id="{{ \Auth::id() }}" >
                                    ...
                                    <a href="{{ url('logout') }}" class="dropdown-item" onclick="event.preventDefault(); localStorage.clear();  document.getElementById('logout-form').submit();">
