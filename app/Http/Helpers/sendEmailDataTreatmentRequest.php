...
class sendEmailDataTreatmentRequest
{
    public static function sendEmail($usuario_id, $estado, $allEmail = null)
    {
        try {
            ...
            Mail::send('templates.emailSendDataTreatmentRequest', array('request' => $user, 'estado' => $estado), function ($message) use ($user, $allEmail) {
